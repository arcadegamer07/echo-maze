      ...
      <PanelBody className="live-trace-body">
        ...
        <div className="live-trace-layout">
          ...
          <div className="live-trace-data">
            ...
            <div className="trace-metric"><span>Map evidence</span><strong>{latest?.source === 'live' ? 'LIVE / MAPPABLE' : latest?.source === 'fixture' ? 'FIXTURE / IGNORED' : 'AWAITING'}</strong><small>Test packets never alter pose or occupancy</small></div>
